...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        if self.Gameover:
            ...
            arcade.draw_text("THE FORCE IS NOT STRONG WITH THIS ONE. PRESS R TO RESET.",SW/2,SH/2,arcade.color.CITRINE,14,align="center",anchor_x="center")

        output = f"score: {self.score}"
        arcade.draw_text(output,10,20,arcade.color.YELLOW,14,)
